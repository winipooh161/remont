...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Создание объекта</h5>
            <a href="{{ route('partner.projects.index') }}" class="btn btn-outline-secondary btn-sm">
                <i class="fas fa-arrow-left me-1"></i>Назад к списку
            </a>
        </div>
        <div class="card-body">
            <form action="{{ route('partner.projects.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control @error('area') is-invalid @enderror" id="area" name="area" value="{{ old('area') }}">
                            @error('area')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('object_type') is-invalid @enderror" id="object_type" name="object_type">
                                <option value="" {{ old('object_type') == '' ? 'selected' : '' }}>Выберите тип объекта</option>
                                <option value="Квартира" {{ old('object_type') == 'Квартира' ? 'selected' : '' }}>Квартира</option>
                                <option value="Дом" {{ old('object_type') == 'Дом' ? 'selected' : '' }}>Дом</option>
                                <option value="Офис" {{ old('object_type') == 'Офис' ? 'selected' : '' }}>Офис</option>
                                <option value="Коммерческое помещение" {{ old('object_type') == 'Коммерческое помещение' ? 'selected' : '' }}>Коммерческое помещение</option>
                            </select>
                            @error('object_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex">
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" name="work_type" id="work_type_repair" value="repair" {{ old('work_type', 'repair') == 'repair' ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="work_type_repair">Ремонт</label>
                                </div>
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" name="work_type" id="work_type_design" value="design" {{ old('work_type') == 'design' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="work_type_design">Дизайн</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="work_type" id="work_type_construction" value="construction" {{ old('work_type') == 'construction' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" step="0.01" class="form-control @error('work_amount') is-invalid @enderror" id="work_amount" name="work_amount" value="{{ old('work_amount') }}">
                            @error('work_amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" step="0.01" class="form-control @error('materials_amount') is-invalid @enderror" id="materials_amount" name="materials_amount" value="{{ old('materials_amount') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('schedule_link') is-invalid @enderror" id="schedule_link" name="schedule_link" value="{{ old('schedule_link') }}" placeholder="https://">
                                    @error('schedule_link')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="code_inserted" name="code_inserted" value="1" {{ old('code_inserted') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('contact_phones') is-invalid @enderror" id="contact_phones" name="contact_phones" rows="3" placeholder="Укажите дополнительные контактные телефоны, по одному на строку">{{ old('contact_phones') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('branch') is-invalid @enderror" id="branch" name="branch">
                                        <option value="" {{ old('branch') == '' ? 'selected' : '' }}>Выберите филиал</option>
                                        <option value="Москва" {{ old('branch') == 'Москва' ? 'selected' : '' }}>Москва</option>
                                        <option value="Санкт-Петербург" {{ old('branch') == 'Санкт-Петербург' ? 'selected' : '' }}>Санкт-Петербург</option>
                                        <option value="Казань" {{ old('branch') == 'Казань' ? 'selected' : '' }}>Казань</option>
                                    </select>
                                    @error('branch')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                    ...
                    <div class="col-12 mt-4">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('partner.projects.index') }}" class="btn btn-secondary me-2">Отмена</a>
